//
//  HomeScreenLocationsViewViewControllerLeft.m
//  Interface 
//
...
#import "HomeScreenLocationsViewViewControllerLeft.h"

#import "GradientView.h"
#import "MKMapView+ZoomLevel.h"

@implementation HomeScreenLocationsViewViewControllerLeft
...
- (void)viewDidLoad {
  ...
  UIBarButtonItem *barButton1 = [[[UIBarButtonItem alloc] initWithTitle:@"Equipment" style:UIBarButtonItemStyleBordered target:nil action:nil] autorelease];
  ...
  UITabBarItem *tabBarItem1 = [[[UITabBarItem alloc] initWithTitle:@"Equipment" image:[UIImage imageNamed:@"HomeScreenLocationsViewViewControllerLeft_Image_1.png"] tag:1] autorelease];
  ...
  UITabBarItem *tabBarItem2 = [[[UITabBarItem alloc] initWithTitle:@"Personnel" image:[UIImage imageNamed:@"HomeScreenLocationsViewViewControllerLeft_Image_2.png"] tag:2] autorelease];
  ...
  UITabBarItem *tabBarItem3 = [[[UITabBarItem alloc] initWithTitle:@"Survey" image:[UIImage imageNamed:@"HomeScreenLocationsViewViewControllerLeft_Image_3.png"] tag:3] autorelease];
  ...
  UITableView *tableView1 = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, 704) style:UITableViewStyleGrouped];
  tableView1.tag = 1;
  ...
  [tableViewSection1Data setObject:@"Afghanistan" forKey:@"headerText"];
  ...
  tableViewCell1.textLabel.text = @"Bagram";
  ...
  tableViewCell2.textLabel.text = @"Heredia";
  ...
  tableViewCell3.textLabel.text = @"Kandahar";
  ...
  [tableViewSection2Data setObject:@"Germany" forKey:@"headerText"];
  ...
  tableViewCell4.textLabel.text = @"Stuttgart";
  ...
  [tableViewSection3Data setObject:@"Mauritania" forKey:@"headerText"];
  ...
  tableViewCell5.textLabel.text = @"Nouakchott";
  ...
  // ----------------------------;
  // Table View Section -> tableViewSection4;
  // ----------------------------;
  
  NSMutableDictionary *tableViewSection4Data = [NSMutableDictionary dictionary];
  [tableViewSection4Data setObject:@"Niger" forKey:@"headerText"];
  [tableViewSection4Data setObject:@"" forKey:@"footerText"];
  [tableViewSection4Data setObject:[NSMutableArray array] forKey:@"cells"];
  [self.tableView1Data addObject:tableViewSection4Data];
  ...
  tableViewCell6.textLabel.text = @"Niamey";
  ...
  [[tableViewSection4Data objectForKey:@"cells"] addObject:tableViewCell6Data];
...
- (void)didTap_barButton1:(id)sender forEvent:(UIEvent *)event {
  ...
  alertView.title = @"Equipment View";
  alertView.message = @"";
