//
//  HomeScreenEquipmentViewViewControllerLeft.m
//  Interface 
//
...
#import "HomeScreenEquipmentViewViewControllerLeft.h"

#import "GradientView.h"
#import "MKMapView+ZoomLevel.h"

@implementation HomeScreenEquipmentViewViewControllerLeft
...
- (void)viewDidLoad {
  ...
  UITableView *tableView1 = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, 704) style:UITableViewStylePlain];
  tableView1.tag = 1;
  ...
  [tableViewSection1Data setObject:@"Detail and Location" forKey:@"headerText"];
  ...
  tableViewCell1.textLabel.text = @"Flexfuel";
  tableViewCell1.detailTextLabel.text = @"Bagram, Afghanistan";
  ...
  tableViewCell2.textLabel.text = @"Sun Dial";
  tableViewCell2.detailTextLabel.text = @"Niamey, Niger";
  ...
  tableViewCell3.textLabel.text = @"H-Series";
  tableViewCell3.detailTextLabel.text = @"Niamey, Niger";
  ...
  tableViewCell4.textLabel.text = @"T-Series";
  tableViewCell4.detailTextLabel.text = @"Nouakchott, Mauritania";
  ...
  tableViewCell5.textLabel.text = @"Net Zero Combat Outpost";
  tableViewCell5.detailTextLabel.text = @"Dakar, Senegal";
  ...
  UITableViewCell *tableViewCell6 = [[[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:nil] autorelease];
  tableViewCell6.textLabel.text = @"Solar Stik";
  tableViewCell6.detailTextLabel.text = @"Dakar, Senegal";
  ...
  UIView *tableViewHeaderView1 = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 60)] autorelease];
  ...
  navigationBar1.topItem.title = @"Equipment";
  ...
  UIBarButtonItem *barButton1 = [[[UIBarButtonItem alloc] initWithTitle:@"Locations" style:UIBarButtonItemStyleBordered target:nil action:nil] autorelease];
  ...
  UITabBarItem *tabBarItem1 = [[[UITabBarItem alloc] initWithTitle:@"Equipment" image:[UIImage imageNamed:@"HomeScreenEquipmentViewViewControllerLeft_Image_1.png"] tag:1] autorelease];
  ...
  UITabBarItem *tabBarItem2 = [[[UITabBarItem alloc] initWithTitle:@"Personnel" image:[UIImage imageNamed:@"HomeScreenEquipmentViewViewControllerLeft_Image_2.png"] tag:2] autorelease];
  ...
  UITabBarItem *tabBarItem3 = [[[UITabBarItem alloc] initWithTitle:@"Survey" image:[UIImage imageNamed:@"HomeScreenEquipmentViewViewControllerLeft_Image_3.png"] tag:3] autorelease];
